...
AdminService service;
	...
	public void memberAdmin2(Model model, 
			...
			@RequestParam(value = "pageid2",required = false, defaultValue = "") String pageid2) throws Exception {
		
		Adminpage2 page2 = new Adminpage2();
		
		page2.setNum2(num2);
		page2.setCount2(service.searchCountBox2(keyword2)); 
		page2.setKeyword2(keyword2);
		page2.setPageid2(pageid2);
		
		List<MemberVO> list2 = null;
		list2 = service.listPageSearchBox2(page2.getDisplayPost2(), page2.getPostNum2(), keyword2);
